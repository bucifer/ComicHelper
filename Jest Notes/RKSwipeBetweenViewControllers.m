...
- (void)viewDidLoad
{
    ...
    SetsViewController* svc = [storyboard instantiateViewControllerWithIdentifier:@"SetsViewController"];
    HelpMenuController* hmc = [storyboard instantiateViewControllerWithIdentifier:@"HelpMenuController"];

    NSArray *controllers = @[hvc, svc, hmc];
    
    viewControllerArray = [controllers mutableCopy];
